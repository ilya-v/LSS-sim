Этот readme предназначен для N-body.py от 03.04.2018.
Изменения:
...
Оптимальные режамы работы для Tree code:
Число частиц/число ячеек
1000/8
10000/16
100000/16
1000000/16
...
После тестирования обнаружил, что главным тормозом в программе
является функция, отвечающая за получение параметров ячеек.
(Если не понятно, где, то ввести Ctrl+F "Работа сячейками".
Все что выше этой строки и до первой попавшейся
start = time.time())
